        ...
        <>
            ...
            <section class="bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-screen-xl h-screen lg:py-16 lg:px-6">
                    <div class="mt-[20%]  mx-auto max-w-screen-sm text-center">
                        ...
                        <Link to="/" class="inline-flex text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center focus:ring-blue-900 my-4">Back to Homepage</Link>
                    </div>
                </div>
            </section>
        </>
